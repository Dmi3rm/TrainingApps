; (function () {
    ...
    logElem.prototype =
        {
            ...
            countValue: function ()
            {
                if (this.type == 1) //Таблица истинности для And
                {
                    if (this.firstValue == 0)
                    {
                        if (this.secondValue == 0)
                ...
                if (this.type == 2) //Таблица истинности для Or
                {
                    if (this.firstValue == 0) {
                        if (this.secondValue == 0)
                        { this.finalValue = 0; }
                ...
                if (this.type == 3) //Таблица истинности для Not
                {
                    if (this.firstValue == 0) {
                        this.finalValue = 1;
                    }
        ...
        programState.LeftKeyPressed = true;
            if (event.button == 00) 
            {
                if (programState.NowAdding) //Добавление
                {
                    ...
                    {
                        lgElem = new logElem(pictures.AndPicture, 1, event.offsetX - programState.Size / 2, event.offsetY - programState.Size / 2, programState.NewLogElemId);
                    }

                    if(programState.OrTaken) //Or
                    {
                        lgElem = new logElem(pictures.OrPicture, 2, event.offsetX - programState.Size / 2, event.offsetY - programState.Size / 2, programState.NewLogElemId);
                    }

                    if(programState.NotTaken) //Not
                    {
                        lgElem = new logElem(pictures.NotPicture, 3, event.offsetX - programState.Size / 2, event.offsetY - programState.Size / 2, programState.NewLogElemId);
                    }
    ...
    function GetReadyElements()
    {
        ...
        for (var i = 0; i < logElems.length; i++)
        {
            ...
            {
                if (logElems[i].type == 1 || logElems[i].type == 2) //Если элемент типа And или Or
                {
                ...
                if (logElems[i].type == 3) //Если элемент типа Not
                {
                    if ((logElems[i].firstValue == 0) || (logElems[i].firstValue == 1))
    ...
    function RePaint ()
    {
        ...
        for (var i = 0; i < logElems.length; i++)
        {
            ...
            for (var j = 0; j < bindings.length; j++)
            {
                ...
                if ((finishElem.type == 1) || (finishElem.type == 2))
                {
    ...
    function ChangeClickedValue(posX, posY)
    {
        for (var i = 0; i < logElems.length; i++)
        {
            if ((logElems[i].type == 1)||(logElems[i].type == 2))
            {
